...
function s.initial_effect(c)
	...
	--Add "The Wicked Dreadroot" + Extra Tribute Summon
	...
	--Banish from GY; Dreadroot can attack all monsters
...
s.listed_names={62180201} -- ID de The Wicked Dreadroot
...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Extra Tribute Summon (Slifer / Ancient Chant style)
