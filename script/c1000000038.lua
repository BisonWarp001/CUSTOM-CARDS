...
function s.initial_effect(c)
	...
	-- ② When Normal/Special Summoned: Special Summon 1 "Nordic" Tuner from Deck
	...
	e2:SetCountLimit(1,id+101) -- 🔹 Límite por turno
	...
	-- ③ Quick Effect: Negate effect if control Thor
...
--------------------------------
--------------------------------
-- Effect ②: Special Summon 1 "Nordic" Tuner from Deck
...
--------------------------------
-- Effect ③: Quick Effect negate if control Thor
--------------------------------
